...
public class Registro1 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (respuesta == 0){
            PaginaPrincipal IniciaConLogin = new PaginaPrincipal();
            IniciaConLogin.setVisible(true);
            IniciaConLogin.setLocationRelativeTo(null);
            this.setVisible(false);
            JOptionPane.showMessageDialog(null,"Por favor ingrese ahora a traves del boton iniciar sesión","Ingreso Usuario Nuevo", JOptionPane.INFORMATION_MESSAGE);
        }
        }catch (Exception e) {
            this.setVisible(false);
