...
public class AsesorJuridico extends AgenteInterno {
    ...
    public AsesorJuridico(String especialidad, ArrayList<ConsultorJunior> estudiantes, String nombre, String apellido_1, String apellido_2, Date fechaDeNacimiento, String usuario, String password, String idPersonal, Boolean activo) {
